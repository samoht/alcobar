...
(** [dynamic_bind gen f] is a monadic bind, it allows to express the
   ...
   opaque/dynamic (it depends on generated values), the Alcobar
...
(** [run name suites] runs [suites] immediately.
    ...
    - [--gen-corpus DIR]: generate seed corpus files in [DIR] and exit.
      Each file contains the exact bytes consumed by generators during
      a passing run.
